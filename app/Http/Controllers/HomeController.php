...
class HomeController extends Controller
{
    ...
    public function destroy($id){
        ...
        #u tabeli posts  setuje kolonu user_id postova koje je kreirao user koji trebao da se obrise i dodjeljuje joj admin_id i tim ti postovi tog usera postaju admin postovi
