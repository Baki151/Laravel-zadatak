            ...
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    ...
                    <button type="submit" name="submit" class="btn btn-danger btn-outline-secondary" style="border-radius:0;color:black;">Izbrisi korisnika</button>
                            ...
                            <img src="{{asset('storage/slike/'.$user->picture)}}" alt="" style="height:70px;width:70px;border-radius:50%;"><h1 style="margin-top:10px;">{{$user->name}} postovi</h1></center>
        ...
        <footer class="border-top">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy;  Balsa Klikovac {{date("Y")}}</div>
                    </div>
                </div>
            </div>
        </footer>
